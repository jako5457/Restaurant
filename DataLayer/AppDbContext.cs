    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Restaurant>().HasData(
                ...
                new Restaurant { Id = 5, Name = "Kong Hans Kælder", Location = "Copenhagen", Cuisine = CuisineType.Italian, ImageUrl = "https://files.guidedanmark.org/files/382/382_2588.jpg" },
                new Restaurant { Id = 6, Name = "Geranium", Location = "Copenhagen", Cuisine = CuisineType.Mexican, ImageUrl = "https://files.guidedanmark.org/files/382/173006_Geranium.jpg" }
           );
        }
    }
